<?php
$isDisabled = isset($servico) ? 'disabled' : '';
?>
...
@endif
    <div class="form-group row">
        <div class="col-12 col-sm-12 mb-3 mb-sm-0">
            <label>Nome:</label>
            <input type="text" class="form-control form-control-user @error('nome') is-invalid @enderror" name="nome" required {{ $isDisabled }} autocomplete="nome" maxlength="250" autofocus id="nome" value="{{ isset($servico) ? old('nome', $servico->nome) : old('nome') }}">
            @error('nome')
