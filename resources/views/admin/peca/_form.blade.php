<?php
$isDisabled = isset($peca) ? 'disabled' : '';
?>
...
@endif
    <div class="form-group row">
        <div class="col-12 col-sm-6 mb-3 mb-sm-0">
            <label>Nome:</label>
            <input type="text" class="form-control form-control-user @error('nome') is-invalid @enderror" name="nome" {{ $isDisabled }} required autocomplete="nome" maxlength="250" autofocus id="nome" value="{{ isset($peca) ? old('nome', $peca->nome) : old('nome') }}">
            @error('nome')
