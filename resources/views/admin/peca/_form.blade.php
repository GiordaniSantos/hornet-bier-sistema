...
@endif
    @if(isset($peca))
        <div class="form-group row">
            <div class="col-12 col-sm-12 mb-3 mb-sm-0">
                <label>Nome (Somente para Gerenciamento):</label>
                <input type="text" class="form-control form-control-user @error('nome_admin') is-invalid @enderror" name="nome_admin" autocomplete="nome_admin" maxlength="350" autofocus id="nome_admin" value="{{ isset($peca) ? old('nome_admin', $peca->nome_admin) : old('nome_admin') }}">
                @error('nome_admin')
    ...
    <div class="form-group row">
        <div class="col-12 col-sm-6 mb-3 mb-sm-0">
            <label>Nome (Que aparecerá na OS):</label>
